...
namespace ProductTest.Application.Features.v2.Products.Queries.SearchProducts;

public sealed record SearchProductsQuery(
    SearchProductRequest Request) : IRequest<SearchProductResponse>;

public sealed class SearchProductsQueryHandler(IProductRepositoryV2 productRepository, IMapper mapper) : IRequestHandler<SearchProductsQuery, SearchProductResponse>
{
