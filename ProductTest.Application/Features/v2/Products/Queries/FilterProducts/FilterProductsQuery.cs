...
namespace ProductTest.Application.Features.v2.Products.Queries.FilterProducts;

public sealed record FilterProductsQuery(
    FilterProductRequest Request) : IRequest<FilterProductResponse>;

public sealed class FilterProductsQueryHandler(IProductRepositoryV2 productRepository, IMapper mapper) : IRequestHandler<FilterProductsQuery, FilterProductResponse>
{
