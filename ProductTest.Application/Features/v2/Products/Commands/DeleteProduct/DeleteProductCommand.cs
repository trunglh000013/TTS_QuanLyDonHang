...
namespace ProductTest.Application.Features.v2.Products.Commands.DeleteProduct;

public sealed record DeleteProductCommand(
    DeleteProductRequest Request
) : IRequest<DeleteProductResponse>;

public sealed class DeleteProductCommandHandler(IProductRepositoryV2 productRepository)
