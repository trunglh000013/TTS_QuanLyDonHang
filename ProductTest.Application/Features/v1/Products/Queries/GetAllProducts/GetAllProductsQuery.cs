...
namespace ProductTest.Application.Features.v1.Products.Queries.GetAllProducts;

public sealed record GetAllProductsQuery(GetAllProductRequest Request) : IRequest<GetAllProductResponse>;

public sealed class GetAllProductsQueryHandler(IProductRepositoryV1 productRepository, IMapper mapper) : IRequestHandler<GetAllProductsQuery, GetAllProductResponse>
{
