...
using ProductTest.Application.Features.v1.Products.Commands.DeleteProduct;
using ProductTest.Application.Features.v1.Products.Commands.CreateProduct;
using ProductTest.Application.Features.v1.Products.Commands.UpdateProduct;
using ProductTest.Application.Features.v1.Products.Queries.GetAllProducts;
using ProductTest.Application.Features.v1.Products.Queries.GetProductById;
using ProductTest.Application.Features.v1.Products.Queries.SearchProducts;
using ProductTest.Application.Features.v1.Products.Queries.FilterProducts;
...
public sealed class ProductController(IMediator mediator, IStringLocalizer<SharedResource> localizer, ILogger<ProductController> logger) : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        logger.LogInformation("Create product request completed");
        return Ok(product);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(localizer["ProductDeleted"]);
    }
